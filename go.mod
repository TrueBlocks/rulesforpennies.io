...
require (
	...
	github.com/TrueBlocks/trueblocks-art/packages/prompt v0.0.0-00010101000000-000000000000
...
require (
	github.com/TrueBlocks/trueblocks-art/packages/creds v0.0.0 // indirect
